...
set_cardinality (mkSet l) = list.length l

-------------------------------------

-- If v is in s return true, otherwise false
--set_member: (v: a) -> (s: set a) -> bool
set_member v (mkSet l) = list.member v l
...
list_difference l1 (h::t) = ite (member h l1) (list_difference l1 t) (h::list_difference l1 t)
...
set_exists p (mkSet l) = list.foldr or true (map p l)
...
list_witness f nil = none
list_witness f (h::t) = ite (f h) (some h) (list_witness f t)
